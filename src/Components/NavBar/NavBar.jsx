      ...
      <div className="navbar  max-xl:max-w-7xl max-lg:max-w-5xl max-md:max-w-3xl max-sm:max-w-screen-sm text-gray-800 w-[97%] mx-auto">
        ...
        <div className="navbar-end gap-3">
             ...
             <div className="flex gap-3">
                 ...
                 {
                    user? 
                    ( <button onClick={handelSignOut}  className="px-3 py-2 md:px-6 md:py-2 rounded-full bg-linear-to-br from-pink-500 via-purple-600 to-indigo-400 text-white font-semibold  hover:from-indigo-500 hover:to-pink-500 ">Sign Out</button>) 

                    : (<Link to="/login" className="px-3 py-2 md:px-6 md:py-2 rounded-full bg-linear-to-br from-pink-500 via-purple-600 to-indigo-400 text-white font-semibold  hover:from-indigo-500 hover:to-pink-500 ">Login</Link>)
                 }
