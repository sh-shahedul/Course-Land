    ...
    const handelRegister=(e)=>{
     ...
     return (
        <div className='flex justify-center min-h-screen items-center bg-linear-to-bl from-indigo-200 via-purple-200 to-pink-200'>
             <div className="card bg-white/55 w-full max-w-sm shrink-0 shadow-2xl">
          ...
          <div className='relative'>
           ...
           {/* term  */}
              ...
              <label className="label mt-2 flex items-center gap-2">
                                ...
                                <p className="text-gray-600 font-medium">I agree to the <span className="text-pink-500 font-bold">terms & conditions</span>.</p>
                            </label>
          {
          ...
          }
          {
           ...
           <button type='submit' className="text-white mt-2 font-bold px-4 py-2 rounded-2xl bg-linear-to-br from-pink-500 via-purple-600 to-indigo-400 hover:from-indigo-500 hover:to-pink-500 transition-all duration-300 focus:outline-none cursor-pointer">Register</button>
                 </fieldset>
            </form>
              <p className='divider'>OR</p>
                <button onClick={handelGoogleUser} className="btn w-full btn-outline border-pink-400 text-pink-500 hover:bg-purple-100 hover:border-border-500 flex items-center justify-center gap-2 transition">
                <FcGoogle size={18} />
                Login with Google
                </button>
...
//       }
//      return (
//         <div className='flex justify-center min-h-screen items-center bg-linear-to-br from-pink-100 via-pink-200 to-pink-50 '>
//              <div className="card bg-white/35 w-full max-w-sm shrink-0 shadow-2xl">
//             <div className="card-body">

//             <form onSubmit={handelRegister}>
//                 <fieldset className="fieldset">
//                     <h2 className='text-2xl font-semibold text-center py-6 bg-linear-to-r from-pink-500 via-red-500 to-pink-300 text-transparent bg-clip-text'>Register your account</h2>
//                     <hr className='text-gray-200 pb-4' />
//                {/* name  */}
//           <label className="label text-gray-800 font-semibold">Name</label>
//           <input 
...
//             success &&  <h1 className='text-green-600 font-medium'>{success}</h1>
//           }
//            <button type='submit' className="text-white mt-2 font-bold px-4 py-2 rounded-2xl bg-linear-to-l from-pink-400 via-pink-500 to-pink-600 hover:from-pink-500 hover:to-pink-700 transition-all duration-300 focus:outline-none">Register</button>
//                  </fieldset>
//             </form>
//               <p className='divider'>OR</p>
//                 <button onClick={handelGoogleLogin} className="btn w-full btn-outline border-pink-400 text-pink-500 hover:bg-pink-100 hover:border-border-500 flex items-center justify-center gap-2 transition">
//                 <FcGoogle size={18} />
//                 Login with Google
//                 </button>
//               <p className='font-semibold text-center py-3'>All ready Have An Account ? <Link to='/login' className='text-secondary underline'>Login</Link></p>
