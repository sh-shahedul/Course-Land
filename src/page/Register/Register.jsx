...
//               photo,
//             }
//            axios.post('https://online-learning-platform-server-livid.vercel.app/course',userInfo)
//              .catch((error)=>{
    ...
    <div className='flex justify-center min-h-screen items-center py-15'>
      <div className="card border border-white w-full max-w-sm shrink-0 shadow-2xl">
        <div className="card-body">
          <form onSubmit={handelRegister}>
            <fieldset className="fieldset">
              <h2 className='text-2xl font-semibold text-center py-6 bg-linear-to-r from-pink-500 via-purple-500 to-indigo-500 text-transparent bg-clip-text'>
              ...
              <div className='relative'>
                <input 
                  ...
                  placeholder="Password" 
                />
                <p onClick={() => handelShow(!show)} className='absolute top-3 right-4 cursor-pointer'>
                  {show ? <PiEyeBold size={18}/> : <TbEyeClosed size={18}/>}
                </p>
              </div>
              ...
              <label className="label mt-2 flex items-center gap-2">
                <input 
                  type="checkbox" 
                  name="term" 
                  className="checkbox checked:border-pink-500 checked:bg-pink-400 checked:text-white"
                />
                <p className="text-gray-600 dark:text-gray-300 font-medium">
                  I agree to the <span className="text-pink-500 font-bold">terms & conditions</span>.
                </p>
              </label>
              ...
              <button 
                type='submit' 
                className="w-full text-center bg-linear-to-r from-pink-500 via-purple-600 to-indigo-500 text-white font-medium py-2 rounded-full hover:from-indigo-500 hover:to-pink-500 transition-all duration-300 mt-2"
              >
                Register
              </button>
            </fieldset>
          ...
          <button 
            onClick={handelGoogleUser} 
            className="btn w-full btn-outline border-pink-400 text-pink-500 hover:bg-white hover:border-border-500 flex items-center justify-center gap-2 transition rounded-full"
          >
            <FcGoogle size={18} />
            Login with Google
          </button>
